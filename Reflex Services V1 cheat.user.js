...
<div class="celemenu">
	...
	<div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 5px;">
		<div class="btn" onclick="window.open('https://discord.gg/reflexservices', '_blank')">Discord</div>
        <div class="btn" onclick="window.open('https://youtu.be/TDKdXfTCDyA', '_blank')">Latest video</div>
	</div>
</div>
</div>
